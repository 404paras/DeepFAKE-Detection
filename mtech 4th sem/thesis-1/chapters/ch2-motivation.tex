...
% =========================================================
\chapter{Motivation}
The proliferation of highly realistic deepfakes presents significant risks to public trust, financial systems, and personal privacy. Despite continued progress in detection research, media circulation remains challenging due to domain shifts, compression artifacts, and evolving manipulation techniques. This chapter articulates the practical significance and technical challenges motivating this thesis, formulates research questions, and outlines the design principles guiding the two-phase approach. The goal is to frame the architectural choices and evaluation protocols used in the accompanying works.
...
\begin{itemize}
    ...
    \item \textbf{RQ3:} How do aggregated training and data augmentation influence performance across the visual and multimodal benchmark settings studied here?
\end{itemize}
...
This thesis preserves the datasets, architectural components, and reported result summaries from the accompanying publications. Core metrics include Accuracy, AUC-ROC, F1, Precision, and Recall, with confusion matrices intentionally omitted in favor of the summary metrics reported in the two studies.

% Context: Connects Motivation to the forthcoming Methodology and Experiments chapters
\section{Summary}
The above considerations motivate a two-phase approach that couples hybrid spatial–temporal video analysis with explicit audio–visual synchrony modeling. The remainder of the thesis follows the structure and reported findings of the accompanying visual and multimodal studies.